...
import 'views/history_screen.dart'; // Import HistoryScreen
import 'views/settings_screen.dart'; // Import SettingsScreen
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => GetMaterialApp(
          ...
          getPages: [
            ...
            GetPage(
                name: '/history',
                page: () => HistoryScreen()), // Added HistoryScreen route
            GetPage(
                name: '/settings',
                page: () => SettingsScreen()), // Added SettingsScreen route
          ],
        ));
  }
}
